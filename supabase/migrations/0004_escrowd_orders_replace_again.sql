-- 0003 was recorded as applied, then Scope Guard columns/tables were put back
-- on the hosted project (client_id NOT NULL, status pending_payment|paid, …).
-- Escrowd insert does not send client_id. Replace again. Drops unpaid test rows.
